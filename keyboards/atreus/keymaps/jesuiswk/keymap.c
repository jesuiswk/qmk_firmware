...
[SYMB] = {
  ...
  {KC_AT,   KC_AMPR, KC_LPRN, KC_RPRN, MY_SCLN, KC_TRNS, KC_MINS, KC_DOT,  KC_QUOT, KC_TRNS, KC_TILD},
  {KC_HASH, KC_PIPE, KC_LCBR, KC_RCBR, KC_SLSH, KC_TRNS, KC_UNDS, KC_GRV,  KC_DQT,  KC_TRNS, KC_CIRC},
